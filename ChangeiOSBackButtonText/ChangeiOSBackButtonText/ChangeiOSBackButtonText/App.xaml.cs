...
namespace ChangeiOSBackButtonText
{
    public partial class App
    {
        ...
        protected override void RegisterTypes(IContainerRegistry containerRegistry)
        {
            ...
            containerRegistry.RegisterForNavigation<NaviCustomPage, NaviCustomPageViewModel>();
            containerRegistry.RegisterForNavigation<NextPage, NextPageViewModel>();
            containerRegistry.RegisterForNavigation<CanChangePage, CanChangePageViewModel>();
        }
    }
}
